...
import { Link } from 'react-router-dom'; // අර කලින් දාපු package එක

// 1. Assets ෆෝල්ඩරයේ තියෙන ලෝගෝ එක Import කරගන්නවා
...
function Login() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden font-sans animate-fade-in">
      ...
      {/* Background Decorative Blobs - ඩිසයින් එකට ගැඹුරක් දෙන්න */}
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        {/* Footer info - අපේ Patient Portal එකට link එකක් */}
